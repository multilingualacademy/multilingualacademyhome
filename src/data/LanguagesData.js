export const languagesData = [
  {
    name: 'Inglés',
    slug: 'ingles',
    description: 'El inglés es el idioma más hablado en el mundo de los negocios y la tecnología. Dominar el inglés te abrirá puertas en tu carrera profesional y te permitirá comunicarte globalmente.',
  ...
  },
  {
    ...
    translation: "Spanish",
    levels: [
      { name: 'Basic', url: 'https://multilingualacademyebas.netlify.app/' },
      { name: 'Intermedium', url: 'https://multilingualacademyeint.netlify.app/' },
      { name: 'Advanced', url: 'https://multilingualacademyeava.netlify.app/' },
  ...
  },
  {
    name: 'Francés',
    slug: 'frances',
    description: 'El francés es un idioma romántico hablado en cinco continentes. Es esencial para quienes desean trabajar en diplomacia, gastronomía o moda.',
  ...
  },
  {
    name: 'Italiano',
    slug: 'italiano',
    description: 'El italiano es conocido por su belleza y riqueza cultural. Es el idioma de la ópera, el arte renacentista y la cocina tradicional.',
  ...
  },
  {
    name: 'Portugués',
    slug: 'portugues',
    description: 'El portugués es el idioma oficial de Brasil y Portugal. Es esencial para los negocios en Sudamérica y Europa.',
  ...
  },
  {
    name: 'Alemán',
    slug: 'aleman',
    description: 'El alemán es el idioma más hablado en Europa y es esencial en la ingeniería, la ciencia y los negocios globales.',
  ...
  },
  {
    name: 'Ruso',
    slug: 'ruso',
    description: 'El ruso es el idioma más hablado en Eurasia. Es clave en negocios, literatura clásica y exploración científica.',
  ...
  },
  {
    name: 'Mandarín',
    slug: 'mandarin',
    description: 'El mandarín es el idioma más hablado del mundo. Es esencial para los negocios en Asia y el comercio internacional.',
  ...
  },
  {
    name: 'Japonés',
    slug: 'japones',
    description: 'El japonés es esencial para comprender la cultura única de Japón, además de ser clave en tecnología y entretenimiento.',
